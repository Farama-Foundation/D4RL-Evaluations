...
from algae_dice import conv_algae as algae
...
flags.DEFINE_string('env_name', 'carla-lane-v0',
                    'Environment for training/evaluation.')
flags.DEFINE_integer('seed', 42, 'Fixed random seed for training.')
flags.DEFINE_integer('sample_batch_size', 32, 'Batch size.')
...
flags.DEFINE_boolean('use_dqn', False, 'Use double q learning.')
...
flags.DEFINE_integer('max_timesteps', int(5e4), 'Max timesteps to train.')
